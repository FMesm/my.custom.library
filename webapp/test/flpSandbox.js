		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#umgmycustomlibrary-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"umgmycustomlibrary-display": {
								"semanticObject": "umgmycustomlibrary",
								"action": "display",
								"description": "A custom library for testing purpose",
								"title": "Custom library",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=umg.my.custom.library",
									"url": sap.ui.require.toUrl("umg/my/custom/library")
								}
							}
						}
					}
